...
// Ensure the checkbox starts unchecked and nodeHolder starts invisible
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("connectomeCheckbox").checked = false;
  document.getElementById("nodeHolder").style.opacity = "0";
});
